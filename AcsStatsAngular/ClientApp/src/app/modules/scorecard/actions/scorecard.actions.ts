...
export const LoadScorecardListFailureAction = createAction(LOAD_SCORECARD_LIST_FAILURE)
...
export const LoadScorecardFailureAction = createAction(LOAD_SCORECARD_FAILURE)
...
export const LoadByDecadeFailureAction = createAction(LOAD_BYDECADE_FAILURE)
...
export const LoadByYearFailureAction = createAction(LOAD_BYYEAR_FAILURE)

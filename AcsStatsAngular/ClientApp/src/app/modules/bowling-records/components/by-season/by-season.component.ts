...
export class BySeasonComponent implements OnInit {
  bowlingBySeason$!: Observable<BowlingOverallUiModel>;
  ...
  ngOnInit(): void {
    ...
    this.bowlingBySeason$ = this.bowlingStore.select(s => {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      this.bowlingStore.dispatch(LoadBySeasonBowlingRecordsAction({payload: fbo}))
      ...
      this.bowlingBySeason$.subscribe(payload => {
  ...
  sort(sortOrder: SortOrder) {
    ...
    this.bowlingStore.dispatch(SortBowlingRecordsBySeasonAction({
      payload: {
        sortOrder,
        sortDirection
      }

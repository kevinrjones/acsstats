...
import {LoadByHostBowlingRecordsAction, SortBowlingRecordsByHostAction} from "../../actions/records.actions";
...
export class ByHostComponent implements OnInit {
  bowlingByHost$!: Observable<BowlingOverallUiModel>;
  ...
  ngOnInit(): void {
    ...
    this.bowlingByHost$ = this.bowlingStore.select(s => {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      this.bowlingStore.dispatch(LoadByHostBowlingRecordsAction({payload: fbo}))
      ...
      this.bowlingByHost$.subscribe(payload => {
  ...
  sort(sortOrder: SortOrder) {
    ...
    this.bowlingStore.dispatch(SortBowlingRecordsByHostAction({
      payload: {
        sortOrder,
        sortDirection
      }

...
export const LoadOverallBowlingRecordsFailureAction = createAction(LOAD_OVERALL_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadInnByInnBowlingRecordsFailureAction = createAction(LOAD_INNBYINN_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByMatchBowlingRecordsFailureAction = createAction(LOAD_BYMATCH_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadBySeriesBowlingRecordsFailureAction = createAction(LOAD_BYSERIES_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByGroundBowlingRecordsFailureAction = createAction(LOAD_BYGROUND_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByHostBowlingRecordsFailureAction = createAction(LOAD_BYHOST_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByOppositionBowlingRecordsFailureAction = createAction(LOAD_BYOPPOSITION_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadBySeasonBowlingRecordsFailureAction = createAction(LOAD_BYSEASON_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByYearBowlingRecordsFailureAction = createAction(LOAD_BYYEAR_BOWLINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())

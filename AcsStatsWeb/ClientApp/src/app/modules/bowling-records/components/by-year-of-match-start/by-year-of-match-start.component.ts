...
import {LoadByYearBowlingRecordsAction, SortBowlingRecordsByYearAction} from "../../actions/records.actions";
...
export class ByYearOfMatchStartComponent implements OnInit {
  ...
  sort(sortOrder: SortOrder) {
    ...
    this.bowlingStore.dispatch(SortBowlingRecordsByYearAction({
      payload: {
        sortOrder,
        sortDirection
      }

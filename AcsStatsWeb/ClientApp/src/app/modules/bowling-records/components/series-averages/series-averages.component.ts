...
import {LoadBySeriesBowlingRecordsAction, SortBowlingRecordsBySeriesAction} from "../../actions/records.actions";
...
export class SeriesAveragesComponent implements OnInit {
  ...
  sort(sortOrder: SortOrder) {
    ...
    this.bowlingStore.dispatch(SortBowlingRecordsBySeriesAction({
      payload: {
        sortOrder,
        sortDirection
      }

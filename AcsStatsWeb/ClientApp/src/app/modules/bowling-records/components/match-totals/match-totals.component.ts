...
import {LoadByMatchBowlingRecordsAction, SortBowlingRecordsByMatchAction} from "../../actions/records.actions";
...
export class MatchTotalsComponent implements OnInit {
  ...
  sort(sortOrder: SortOrder) {
    ...
    this.bowlingStore.dispatch(SortBowlingRecordsByMatchAction({
      payload: {
        sortOrder,
        sortDirection
      }

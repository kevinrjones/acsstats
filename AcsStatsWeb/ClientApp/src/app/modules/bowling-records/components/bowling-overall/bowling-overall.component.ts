...
import {LoadOverallBowlingRecordsAction, SortBowlingRecordsOverallAction} from "../../actions/records.actions";
...
export class BowlingOverallComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      this.bowlingStore.dispatch(LoadOverallBowlingRecordsAction({payload: fbo}))
      ...
      this.bowlingOverall$.subscribe(payload => {
  ...
  sort(sortOrder: SortOrder) {
    ...
    this.bowlingStore.dispatch(SortBowlingRecordsOverallAction({
      payload: {
        sortOrder,
        sortDirection
      }

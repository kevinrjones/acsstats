...
// export const LoadOverallBattingRecordsFailureAction = createAction(LOAD_OVERALL_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadInnByInnBattingRecordsFailureAction = createAction(LOAD_INNBYINN_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByMatchBattingRecordsFailureAction = createAction(LOAD_BYMATCH_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadBySeriesBattingRecordsFailureAction = createAction(LOAD_BYSERIES_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByGroundBattingRecordsFailureAction = createAction(LOAD_BYGROUND_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByHostBattingRecordsFailureAction = createAction(LOAD_BYHOST_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByOppositionBattingRecordsFailureAction = createAction(LOAD_BYOPPOSITION_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadBySeasonBattingRecordsFailureAction = createAction(LOAD_BYSEASON_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())
...
export const LoadByYearBattingRecordsFailureAction = createAction(LOAD_BYYEAR_BATTINGRECORDS_FAILURE, props<{ payload: ErrorDetails }>())

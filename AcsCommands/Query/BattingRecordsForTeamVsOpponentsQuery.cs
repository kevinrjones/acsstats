...
public class
    BattingRecordsForTeamVsOpponentsQuery : IRequest<
        Result<SqlResultEnvelope<IReadOnlyList<BattingCareerRecordDto>>, Error>>
{
    ...
    internal class BattingRecordsForTeamVsOpponentsQueryHandler
        : IRequestHandler<BattingRecordsForTeamVsOpponentsQuery,
            Result<SqlResultEnvelope<IReadOnlyList<BattingCareerRecordDto>>, Error>>
    {
        ...
        public async Task<Result<SqlResultEnvelope<IReadOnlyList<BattingCareerRecordDto>>, Error>> Handle(
            BattingRecordsForTeamVsOpponentsQuery request, CancellationToken cancellationToken)
        {
            try
            {

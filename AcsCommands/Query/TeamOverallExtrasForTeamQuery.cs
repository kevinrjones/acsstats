...
public class TeamOverallExtrasForTeamQuery : IRequest<Result<IReadOnlyList<TeamExtrasDetailsDto>, Error>>
{
    private SharedModel Model { get; }

    public TeamOverallExtrasForTeamQuery(SharedModel model)
    {
        Model = model;
    }

    internal class TeamOverallExtrasForTeamQueryHandler
        : IRequestHandler<TeamOverallExtrasForTeamQuery, Result<IReadOnlyList<TeamExtrasDetailsDto>, Error>>
    {
        private readonly QueriesConnectionString _queriesConnectionString;
        private readonly ILogger<TeamOverallExtrasForTeamQueryHandler> _logger;

        public TeamOverallExtrasForTeamQueryHandler(
            QueriesConnectionString queriesConnectionString,
            ILogger<TeamOverallExtrasForTeamQueryHandler> logger)
        {
        ...
        public async Task<Result<IReadOnlyList<TeamExtrasDetailsDto>, Error>> Handle(
            TeamOverallExtrasForTeamQuery request, CancellationToken cancellationToken)
        {

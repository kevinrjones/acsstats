...
public class BowlingRecordsCompleteQuery : IRequest<Result<IReadOnlyList<BowlingCareerRecordDto>, Error>>
{
    ...
    internal class BowlingRecordsCompleteQueryHandler
        : IRequestHandler<BowlingRecordsCompleteQuery, Result<IReadOnlyList<BowlingCareerRecordDto>, Error>>
    {
        ...
        public async Task<Result<IReadOnlyList<BowlingCareerRecordDto>, Error>> Handle(BowlingRecordsCompleteQuery request,

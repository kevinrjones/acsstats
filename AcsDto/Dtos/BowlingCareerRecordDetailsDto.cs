...
public record BowlingCareerRecordDetailsDto(
    string Name,
    string Team,
    string Opponents,
    string Year,
...
{
    public static string Format(this BowlingCareerRecordDetailsDto dto)
    {
    ...
    public static string FormatHeader(this IReadOnlyList<BowlingCareerRecordDetailsDto> _)
    {
